          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-8">
                ...
                <Link href="/chatbot" className="text-sm font-medium text-white hover:text-white/80 transition-colors">
                  AI Assistant
                </Link>
        ...
        <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4">
          <div className="max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg text-purple-200/90 sm:text-xl text-pretty max-w-3xl mx-auto leading-relaxed">
              Your intelligent travel companion for finding perfect accommodations, connecting with fellow travelers,
